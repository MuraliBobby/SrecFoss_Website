        ...
        <x-splade-modal>
            <form action="{{route('event.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="event_name" name="event_name" class="w-full px-3 py-2 border rounded-md" value="{{$event->event_name}}" required>
                </div>
    
                <div class="mb-4">
                    <label for="event_description" class="block text-gray-700 text-sm font-bold mb-2">Event Description:</label>
                    <textarea id="event_description" name="event_description" class="w-full px-3 py-2 border rounded-md" value="{{$event->event_description}}" required></textarea>
                </div>
                
                <div class="mb-4">
                    <label for="event_date" class="block text-gray-700 text-sm font-bold mb-2">Event Date:</label>
                    <input type="date" id="event_date" name="event_date" class="w-full px-3 py-2 border rounded-md" value="{{$event->event_date}}" required>
                </div>
                
                <div class="mb-4">
                    <label for="event_duration" class="block text-gray-700 text-sm font-bold mb-2">Event Duration:</label>
                    <input type="text" id="event_duration" name="event_duration" class="w-full px-3 py-2 border rounded-md" value="{{$event->event_duration}}" required>
                </div>

                <div class="mb-4">
                    <label for="event_venue" class="block text-gray-700 text-sm font-bold mb-2">Event Venue:</label>
                    <input type="text" id="event_venue" name="event_venue" class="w-full px-3 py-2 border rounded-md" value="{{$event->event_venue}}" required>
                </div>
                ...
                @if($event->participation_certificate == 1)
                    <div class="mb-4">
                        ...
                        <input type="checkbox" id="participation_certificate" name="participation_certificate" class="w-full px-3 py-2 border rounded-md" checked>
                    </div>
                @else
                    <div class="mb-4">
                        <label for="participation_certificate" class="block text-gray-700 text-sm font-bold mb-2">Participation Certificate:</label>
                ...
                @if($event->winner_runner_certificate == 1)
                    ...
                    <div class="mb-4">
                        ...
                        <input type="checkbox" id="winner_runner_certificate" name="winner_runner_certificate" class="w-full px-3 py-2 border rounded-md" checked>
                    </div>
                @else                
                    <div class="mb-4">
                        <label for="winner_runner_certificate" class="block text-gray-700 text-sm font-bold mb-2">Winner / Runner Certificate:</label>
                ...
                @if($event->cash_prize == 1)
                    <div class="mb-4">
                        ...
                        <input type="checkbox" id="cash_prize" name="cash_prize" class="w-full px-3 py-2 border rounded-md" checked>
                    </div>
                @else
                    <div class="mb-4">
                        <label for="cash_prize" class="block text-gray-700 text-sm font-bold mb-2">Cash Prize:</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="registration_link" name="registration_link" class="w-full px-3 py-2 border rounded-md" value="{{$event->registration_link}}" required>
                </div>

                <div class="mb-4">
                    <label for="event_status" class="block text-gray-700 text-sm font-bold mb-2">Event Status:</label>
                    <select id="event_status" name="event_status" class="w-full px-3 py-2 border rounded-md" value="{{$event->event_status}}" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="poster_path" name="poster_path" class="w-full px-3 py-2 border rounded-md" value="{{$event->poster_path}}" required>
                </div>
